...
const footerSource = fs.readFileSync(
  path.join('./backend', 'globalServices', 'mailer', 'templates', 'footer.hbs'),
  'utf8'
)
const headerSource = fs.readFileSync(
  path.join('./backend', 'globalServices', 'mailer', 'templates', 'header.hbs'),
  'utf8'
)
...
module.exports.mailConfirm = async (user) => {
...
module.exports.mailLosspass = async (user) => {
...
module.exports.mailPreincriptionToUser = (datas) => {
  const options = {
...
module.exports.mailPreincriptionToManager = (datas) => {
...
module.exports.mailUserSuggestion = (suggestion, user) => {
...
module.exports.mailAdminSuggestion = (suggestion, user) => {
  const emailUserSuggestionTemplateSource = fs.readFileSync(
    path.join(
      './backend',
      'globalServices',
...
module.exports.mailAllUsers = (mail, user) => {
...
module.exports.mailPaper = (paper, user) => {
...
module.exports.mailAlbum = (album, user) => {
