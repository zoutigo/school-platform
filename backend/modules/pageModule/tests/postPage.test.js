...
describe('PAGE - POST', () => {
  ...
  it('should create new page', async () => {
    ...
    expect(newPage.body.datas).not.toHaveProperty('id')
    expect(newPage.body.datas).toHaveProperty('uuid')
    expect(newPage.body.datas).toHaveProperty('title')
    expect(newPage.body.datas).toHaveProperty('slug')
    expect(newPage.body.datas).toHaveProperty('createdAt')
    expect(newPage.body.datas).toHaveProperty('updatedAt')
    expect(newPage.body.datas).toHaveProperty('deletedAt')
  })
})
