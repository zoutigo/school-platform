...
describe('DIALOG - GET', () => {
  ...
  it('should create new dialog', async () => {
    ...
    expect(getDialog.statusCode).toEqual(200)
    expect(getDialog.body.datas).not.toHaveProperty('id')
    expect(getDialog.body.datas).toHaveProperty('uuid')
    expect(getDialog.body.datas).toHaveProperty('title')
    expect(getDialog.body.datas).toHaveProperty('content')
    expect(getDialog.body.datas).toHaveProperty('startdate')
    expect(getDialog.body.datas).toHaveProperty('enddate')
    expect(getDialog.body.datas).toHaveProperty('createdAt')
    expect(getDialog.body.datas).toHaveProperty('updatedAt')
    expect(getDialog.body.datas).toHaveProperty('deletedAt')
  })
})
