...
describe('DIALOG - POST', () => {
  ...
  it('should create new dialog', async () => {
    ...
    expect(newDialog.body.datas).not.toHaveProperty('id')
    expect(newDialog.body.datas).toHaveProperty('uuid')
    expect(newDialog.body.datas).toHaveProperty('title')
    expect(newDialog.body.datas).toHaveProperty('content')
    expect(newDialog.body.datas).toHaveProperty('startdate')
    expect(newDialog.body.datas).toHaveProperty('enddate')
    expect(newDialog.body.datas).toHaveProperty('createdAt')
    expect(newDialog.body.datas).toHaveProperty('updatedAt')
    expect(newDialog.body.datas).toHaveProperty('deletedAt')
  })
})
