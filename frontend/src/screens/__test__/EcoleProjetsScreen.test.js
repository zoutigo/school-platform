...
import EcoleProjetsScreen from '../EcoleProjetsScreen'
...
describe('EcoleProjetsScreen', () => {
  beforeEach(() => {
    ...
    render(<EcoleProjetsScreen />)
  })

  it('should render without bug', () => {
    expect(screen.getByTestId('ecole-projets-screen')).toBeInTheDocument()
  })
