        ...
        <Controller
          ...
          render={() => (
            <Editor
              ...
              apiKey={toString(Variables.TinyMCE_KEY)}
              cloudChannel="dev"
              init={{
                branding: false,
                selector: '#editor',
...
InputEditorControl.defaultProps = {
  initialValue: null,
  height: 300,
}
InputEditorControl.propTypes = {
...
export default InputEditorControl
