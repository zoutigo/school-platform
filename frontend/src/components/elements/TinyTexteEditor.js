    ...
    <StyledEditorGrid item container>
      <Editor
        ...
        init={{
          ...
          plugins:
            'textcolor  importcss autolink directionality link  hr pagebreak nonbreaking anchor  advlist wordcount imagetools textpattern noneditable charmap  emoticons',
          toolbar:
